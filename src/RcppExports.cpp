...
RcppExport SEXP _KDepth_altern_Craw(SEXP xSEXP, SEXP kSEXP, SEXP i0SEXP, SEXP i1SEXP) {
BEGIN_RCPP
...
RcppExport SEXP _KDepth_altern_Craw2(SEXP xSEXP, SEXP kSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericVector >::type x(xSEXP);
...
RcppExport SEXP _KDepth_compKdepth(SEXP xSEXP, SEXP KSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericVector >::type x(xSEXP);
...
RcppExport SEXP _KDepth_kSD_Craw2(SEXP ordSEXP, SEXP sgnSEXP, SEXP kSEXP, SEXP echoSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _KDepth_triangle(SEXP siSEXP, SEXP sjSEXP, SEXP skSEXP, SEXP riSEXP, SEXP rjSEXP, SEXP rkSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _KDepth_kSD_Cfull2(SEXP xSEXP, SEXP rnkSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericVector >::type x(xSEXP);
...
RcppExport SEXP _KDepth_testtriangle(SEXP riSEXP, SEXP rjSEXP, SEXP rkSEXP, SEXP rlSEXP, SEXP tpSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< double >::type ri(riSEXP);
...
RcppExport SEXP _KDepth_kSD_Cfull(SEXP xSEXP, SEXP rnkSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericVector >::type x(xSEXP);
...
RcppExport SEXP _KDepth_C123(SEXP aSEXP, SEXP bSEXP, SEXP cSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _KDepth_C132(SEXP aSEXP, SEXP bSEXP, SEXP cSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< double >::type a(aSEXP);
...
RcppExport SEXP _KDepth_C312(SEXP aSEXP, SEXP bSEXP, SEXP cSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< double >::type a(aSEXP);
...
RcppExport SEXP _KDepth_kSD_Cfull4(SEXP sSEXP, SEXP rSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_KDepth_altern_Craw", (DL_FUNC) &_KDepth_altern_Craw, 4},
    {"_KDepth_altern_Craw2", (DL_FUNC) &_KDepth_altern_Craw2, 2},
    {"_KDepth_compKdepth", (DL_FUNC) &_KDepth_compKdepth, 2},
    {"_KDepth_kSD_Craw2", (DL_FUNC) &_KDepth_kSD_Craw2, 4},
    {"_KDepth_triangle", (DL_FUNC) &_KDepth_triangle, 6},
    {"_KDepth_kSD_Cfull2", (DL_FUNC) &_KDepth_kSD_Cfull2, 2},
    {"_KDepth_testtriangle", (DL_FUNC) &_KDepth_testtriangle, 5},
    {"_KDepth_kSD_Cfull", (DL_FUNC) &_KDepth_kSD_Cfull, 2},
    {"_KDepth_C123", (DL_FUNC) &_KDepth_C123, 3},
    {"_KDepth_C132", (DL_FUNC) &_KDepth_C132, 3},
    {"_KDepth_C312", (DL_FUNC) &_KDepth_C312, 3},
    {"_KDepth_kSD_Cfull4", (DL_FUNC) &_KDepth_kSD_Cfull4, 2},
    {NULL, NULL, 0}
};

RcppExport void R_init_KDepth(DllInfo *dll) {
